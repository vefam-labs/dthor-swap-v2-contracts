...
describe('ExampleComputeLiquidityValue', () => {
  ...
  describe('#getLiquidityValue', () => {
    ...
    describe('fee on', () => {
      ...
      it('correct after swap', async () => {
        ...
        expect(token0Amount).to.eq('1399824899312600205') // 1399824934325735058
        expect(token1Amount).to.eq('35048194774977471355') // 35048195651620807684
      })
    })
  })
  ...
  describe('#getLiquidityValueAfterArbitrageToPrice', () => { // getLiquidityValue
    describe('fee is off', () => {
